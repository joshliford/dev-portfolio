export default function About() {
    ...
    return (
        <div className="max-w-3xl mx-auto py-20 flex flex-col justify-center text-left items-center space-y-6 text-parchment">
            ...
            <p className="font-merriweather text-left text-lg">
                I transitioned from emergency nursing to health informatics, where I supported
                clinical teams by troubleshooting integrated healthcare systems and optimizing workflows
            ...
            <p className="font-merriweather text-lg">
                ...
                and user-focused mindset to build enterprise applications while continuing to grow
